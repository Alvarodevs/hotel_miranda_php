	...
	<section class="rooms">
		...
		<div class="swiper">
					...
					<div class="room-home">
						<div class="room-home__main-container">
							<div class="room-home__bar">
								...
								<img class="room-home__bar__icon" src="./assets/icons/rooms/wifi.svg" alt="Wifi"></img>
								<img class="room-home__bar__icon" src="./assets/icons/rooms/parking.svg" alt="Parking"></img>
								<img class="room-home__bar__icon" src="./assets/icons/rooms/air_cond.svg" alt="Air conditioning"></img>
								<img class="room-home__bar__icon" src="./assets/icons/rooms/gym.svg" alt="Gym"></img>
								<img class="room-home__bar__icon" src="./assets/icons/rooms/no_smoke.svg" alt="No smoke"></img>
								<img class="room-home__bar__icon" src="./assets/icons/rooms/bar.svg" alt="Bar"></img>
							</div>
			...
			<div class="swiper__buttons">
				...
				<div class="swiper-button">
					<div class="swiper-button--next" style="background-image: url(./assets/icons/chevron-right.svg)"></div>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="video-home">
		<div class="video-home__container">
			...
			<div class="video-home__source">
				...
				<iframe class="video-home__source--desktop" src="https://www.youtube.com/embed/Bu3Doe45lcU?start=20&end=75"
					title="Hotel Miranda" width="570px" height="460px"
					allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
					allowfullscreen>
				</iframe>
			</div>
			...
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<div class="swiper-foods__column">
						...
						<div class="food">
							<div class="food__img" style="background-image: url(./assets/images/menu_imgs/tea-coffee.jpg);
                                max-height:100%">
							</div>
						...
						<div class="food">
							<div class="food__img" style="background-image: url(./assets/images/menu_imgs/chia-oatmeal.jpg);
                                max-height:100%">
							</div>
							<div class="food__text">
				...
				<div class="swiper-slide">
					<div class="swiper-foods__column">
						<div class="food">
							<div class="food__img" style="background-image: url(./assets/images/menu_imgs/fruit.jpg);
                                max-height:100%">
							</div>
							<div class="food__text">
						...
						<div class="food">
							<div class="food__img food__img--marmelade" style="background-image: url(./assets/images/menu_imgs/marmelade.jpg);
                                max-height:100%">
							</div>
						...
						<div class="food">
							<div class="food__img" style="background-image: url(./assets/images/menu_imgs/cheese.jpg);
                                max-height:100%">
							</div>
							<div class="food__text">
